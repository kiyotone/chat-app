...
function Chat() {
  ...
  return (
    <div className="flex w-full flex-col bg-[#1e2028] pt-5 rounded-t-3xl pl-5 items-center h-full">
      <div className="flex w-full bg-black h-[52px] rounded-t-3xl items-center pl-3 text-gray-500 text-[16px]">
